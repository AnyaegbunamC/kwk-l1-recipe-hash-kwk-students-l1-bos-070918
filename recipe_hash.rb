...
#   perfect_10_ingredients.each do | recipe_ingredients, measurement |
#     puts "Use #{measurement} of #{recipe_ingredients}."
#   end 
...
# end
# puts amount_of_chocolate_chips(perfect_10_ingredients)
...
def ingredients_and_amounts(perfect_10_ingredients)
  perfect_10_ingredients.each do |recipe_ingredients, measurements|
puts "Recipe Ingredients: #{recipe_ingredients}"
puts "Recipe Measurements: #{measurements}"
end
end 

puts ingredients_and_amounts(perfect_10_ingredients)
